...
class Add:
    ...
    def add_account(self):
        ...
        self.__client.loc[len(self.__client)] = [self.__first_name, self.__last_name, self.__title,
        ...
        print(
            f"{self.__first_name}   {self.__last_name}   {self.__title}   {self.__account_number}   {self.__date_of_birth}    {self.__occupation}     {self.__account_balance}    {self.__overdraft_limit}")
        print("*" * 108)
