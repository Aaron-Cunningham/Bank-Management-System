...
class menu:
    ...
    def add(self):
        ...
        while True:
            ...
            try:
                birthday = input("Enter Birthday in this format dd/m/yyyy: ")
        ...
        clients.loc[len(clients)]=[firstName, lastName, title, accountNumber, dateOfBirth, occupation, accountBalance, overDraftLimit]
        clients.to_csv("data/client_data.csv")
        print(clients)
        print("****************************************\n"
